...
async function testMemberLogin() {
    try {
        ...
        const response = await axios.post('https://dcmsbackend.lanari.rw/api/member-auth/login', {
            phone: '0785419324'
        });
        ...
        if (response.data.token) {
            ...
            const notificationResponse = await axios.get('https://dcmsbackend.lanari.rw/api/member-notifications', {
                headers: {
